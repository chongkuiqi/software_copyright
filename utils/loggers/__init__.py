...
class Loggers():
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.keys = ['train/fam_cls_loss', 'train/fam_reg_loss', 'train/odm_cls_loss', 'train/odm_reg_loss', 'train/conf_loss', # train loss
                     'metrics/precision', 'metrics/recall', 'metrics/mAP_0.5','metrics/conf',  # metrics
                     'val/fam_cls_loss', 'val/fam_reg_loss', 'val/odm_cls_loss', 'val/odm_reg_loss', 'val/conf_loss', # val loss
